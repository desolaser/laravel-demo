...
<div class="col-md-10">
	...
	<div class="box box-info">
		...
		<form class="form-horizontal" action="{{ url('notas/' . $nota->id) }}" method="POST">
			@csrf
			@method('PUT')
			<div class="box-body">
				<div class="form-group">
					...
					<div class="col-sm-11">
						<textarea name="detalle" class="form-control" rows="6" required>{{ old('detalle', $nota->detalle) }}</textarea>
					</div>
				</div>
			</div>
			<!-- /.box-body -->
